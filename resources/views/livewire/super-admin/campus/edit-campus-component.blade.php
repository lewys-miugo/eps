<div class="-mt-[520px] p-4 sm:ml-64">
   <div class="p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700">
    ...
    <div class="mx-4">
        <p class="text-left text-xs text-[#6a767e]"><a href="/" class="uppercase">Home</a> > Admin > Edit Campus/Department</p>
    </div>

    <h1 class="text-center">Edit campus</h1>
    ...
    <div class="mx-8">
        ...
        @endif
        <form class="max-w-md mx-auto" wire:submit.prevent="updateCampus">
